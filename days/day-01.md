...
# 25. Ready-to-paste Day 1 markdown for your repo

You can paste this into `days/day-01.md`:

````md
# Day 1 - DevSecOps Foundations

## Objective
Understand what DevSecOps is, why it matters, and how security fits into the software lifecycle.

## Key Concepts

### What is DevOps?
DevOps is a way of working that brings development and operations together to deliver software faster and more reliably through collaboration and automation.

### What is DevSecOps?
DevSecOps extends DevOps by making security part of the entire software lifecycle instead of leaving it only to the end.

### Why DevSecOps matters
When security is handled late, vulnerabilities are more expensive and slower to fix. DevSecOps reduces risk by introducing security earlier and continuously.

### Shift Left
Shift left means moving security activities earlier into planning, design, and coding rather than waiting until release time.

### Shared Responsibility
In DevSecOps, developers, operations, and security all share responsibility for building and running secure systems.
...
DevSecOps is not just about tools. It is about building software in a way that includes security from the beginning and throughout the lifecycle.


## 26. Suggested project naming for the full course

Use this same app through the course so you build security progressively.

Recommended repo project:
- `secure-shop`
or
- `devsecops-demo-app`

That way each day adds something meaningful instead of starting over.
